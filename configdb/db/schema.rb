...
ActiveRecord::Schema.define(version: 20141105182739) do
  ...
  add_index "devices", ["autnum_id"], name: "index_devices_on_autnum_id", using: :btree
  ...
  add_index "peers", ["device_id"], name: "index_peers_on_device_id", using: :btree
